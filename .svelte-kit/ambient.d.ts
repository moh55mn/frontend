...
declare module '$env/static/private' {
	...
	export const MINIKUBE_WANTUPDATENOTIFICATION: string;
	...
	export const MINIKUBE_FORCE_SYSTEMD: string;
	...
	export const USE_PARTITIONED_COOKIES: string;
	export const GOPATH: string;
	export const npm_package_version: string;
	export const npm_lifecycle_event: string;
	export const PROMPT_COMMAND: string;
	export const EDITOR_PORT: string;
	...
	export const DOCKER_OPTS: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		MINIKUBE_WANTUPDATENOTIFICATION: string;
		HOSTNAME: string;
		GIT_ASKPASS: string;
		...
		SHELL: string;
		USE_PARTITIONED_COOKIES: string;
		GOPATH: string;
